...
#define CONFIG_USB_DWC2_RXALL_FIFO_SIZE (320 - 16 * CONFIG_USBDEV_EP_NUM)
#define CONFIG_USB_DWC2_TX0_FIFO_SIZE (64 / 4)
#define CONFIG_USB_DWC2_TX1_FIFO_SIZE (64 / 4)
#define CONFIG_USB_DWC2_TX2_FIFO_SIZE (64 / 4)
#define CONFIG_USB_DWC2_TX3_FIFO_SIZE (64 / 4)
#define CONFIG_USB_DWC2_TX4_FIFO_SIZE (64 / 4) // 第4个端点不使用
#define CONFIG_USB_DWC2_TX5_FIFO_SIZE (64 / 4) // 第5个端点不使用
