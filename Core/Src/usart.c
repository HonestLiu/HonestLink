...
void MX_USART3_UART_Init(void) {
    ...
    HAL_UART_Receive_DMA(&huart3, uart3_recv_buff, sizeof(uart3_recv_buff));//初始化串口3的DMA接收
...
void chry_dap_usb2uart_uart_config_callback(struct cdc_line_coding *line_coding) {
    ...
    //设置波特率
    huart2.Init.BaudRate = line_coding->dwDTERate;
    //设置校验位
    ...
    //设置字长
    huart2.Init.WordLength = line_coding->bDataBits;
    //设置停止位
    ...
    //配置UART接收DMA
    HAL_UART_Receive_DMA(&huart2, uart3_recv_buff, sizeof(uart3_recv_buff));
}
