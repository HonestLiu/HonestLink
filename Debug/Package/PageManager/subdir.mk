...
C_SRCS += \
../Package/PageManager/PageManager.c 

OBJS += \
./Package/PageManager/PageManager.o 

C_DEPS += \
./Package/PageManager/PageManager.d 


# Each subdirectory must supply rules for building sources it contributes
Package/PageManager/%.o Package/PageManager/%.su Package/PageManager/%.cyclo: ../Package/PageManager/%.c Package/PageManager/subdir.mk
...
clean: clean-Package-2f-PageManager

clean-Package-2f-PageManager:
	-$(RM) ./Package/PageManager/PageManager.cyclo ./Package/PageManager/PageManager.d ./Package/PageManager/PageManager.o ./Package/PageManager/PageManager.su

.PHONY: clean-Package-2f-PageManager
