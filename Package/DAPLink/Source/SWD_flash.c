...
//来源  MIT协议   https://github.com/XIVN1987/DAPProg
/**
 * @note 		用于 Cortex-M 内核 MCU 的离线 SWD 编程器
 * @file    SWD_flash.c
...
{
    swd_flash_syscall_exec(&flash_algo.sys_call_s, flash_algo.uninit, 3, 0, 0, 0,FLASHALGO_RETURN_BOOL);
